 ...
 * [bigaeon.yml](bigaeon.yml)
     * Determines how your purl.obolibrary.org/obo/bigaeon/ redirects will be handled
     ...
     * Paste in the contents of [bigaeon.yml](bigaeon.yml)
 ...
 * [bigaeon.md](bigaeon.md)
     ...
     * Paste in the contents of [bigaeon.md](bigaeon.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
